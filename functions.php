...
function custom_scripts() {
	wp_enqueue_style( 'vendor-style', get_template_directory_uri(). '/includes/css/vendor.min.css' );
	wp_enqueue_style( 'custom-style', get_template_directory_uri(). '/includes/css/custom.min.css' );

	// vendor
	wp_enqueue_script( 'vendor-js', get_template_directory_uri() . '/includes/js/vendor.min.js', null, false, true  );
		
	// custom
	wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/includes/js/custom.min.js', null, false, true  );
}
